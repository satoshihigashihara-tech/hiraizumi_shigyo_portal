...
async function runBlockedPeriodAction(formData, operation) {
  ...
  const fields = Object.fromEntries([
    "blockedPeriodId", "startDate", "endDate", "internalReason", "updatedAt", "reason",
  ...
  if (changeReasonError) return calendarFailure(changeReasonError, fields);
  ...
  if (operation !== "delete") {
    ...
    if (invalid) return calendarFailure(invalid, fields);
