...
const APPLICATIONS = "/user/applications?mode=camp";
...
export default function CampPage() {
  return <div className={styles.page}><PageShell audienceMode="camp" title="スパルタキャンプ参加者の方へ" description="シェアハウスの使用許可申請と申請状況の確認ができます。">
    ...
    <section className={styles.section}><h2>申請と状況確認</h2><div className={styles.actions}><LinkButton href={`/login?returnTo=${encodeURIComponent(APPLICATIONS)}`} variant="primary" fullWidthOnMobile>ログインして申請へ進む</LinkButton><LinkButton href="/signup?returnTo=%2Fuser%2Fapplications%3Fmode%3Dcamp" fullWidthOnMobile>はじめての方はこちら</LinkButton></div></section>
