...
export const ERROR_MESSAGES = {
  ...
  "eligible-email-exists": "このメールアドレスは対象者として登録済みです。登録済みの対象者一覧を確認してください。",
  "eligible-roster-required": "この操作は氏名付き対象者名簿を使うキャンプでのみ利用できます。キャンプの設定を確認してください。",
  "invalid-management-name": "管理用氏名は1文字以上200文字以内で入力してください。",
  "eligible-users-required": "対象者を1人以上入力してください。",
  "too-many-eligible-users": "対象者は施設定員の15人以内で入力してください。",
  "duplicate-eligible-email": "同じキャンプ内でメールアドレスが重複しています。",
  ...
  "room-not-confirmed": "選択した部屋は現在利用できません。画面を再読み込みして確認済みの部屋を選び直してください。",
  "invalid-roster": "対象者名簿の状態を確認できません。名簿を確認してから、もう一度お試しください。",
  "room-change-review-required": "確定済みの部屋割りを変更するには確認が必要です。最新の割当状況を確認してください。",
  "camp-started": "利用開始後は事前部屋割りを変更できません。",
