...
create table private.camp_pdf_render_setting_versions (
  ...
  user_name_limit integer not null check (user_name_limit between 1 and 20),
  user_address_limit integer not null check (user_address_limit between 1 and 30),
  ...
  special_notes_limit integer not null check (special_notes_limit between 1 and 48),
