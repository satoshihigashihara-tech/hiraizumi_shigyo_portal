...
do $$ declare message_value text; begin
  ...
  begin
    ...
    values(1,repeat('a',64),'NotoSerifJP-2.003+sha256:'||repeat('b',64),'mutable-tag:latest','架空町長',20,30,20,30,60,48,15,clock_timestamp());
  ...
  values(1,repeat('a',64),'NotoSerifJP-2.003+sha256:'||repeat('b',64),
    'ghcr.io/example.invalid/camp-pdf-renderer@sha256:'||repeat('c',64),'架空町長',20,30,20,30,60,48,15,clock_timestamp());
